                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="{{url('#customer')}}">Clientelle</a>
                              </li>
                              <li class="nav-item">
         ...
         <div class="footer">
            ...
            <div class="copyright">
               <div class="container">
                  <div class="row">
                     <div class="col-md-12">
                        <p>Copyright &copy; <script>document.write(new Date().getFullYear());</script>| <a href="http://mtaanitech-hub.co.ke"><span>Archie Nailspot Co</span></a> | All rights reserved.</p>
                     </div>
                  </div>
               </div>
            </div>
